...
No synthetic TheHive screenshot is promoted in this slice. The accepted interface is an API-governed handoff path rather than a new operator GUI; fabricating a screenshot would falsely imply a deployed TheHive tenant or live integration evidence.
