...
flowchart LR
    ...
    BUILD --> IMAGE[Minimal DTMO runtime image/archive]
...
1. **PR engineering evidence:** exact-head contract tests, minimal-runtime verification, Trivy-owned SBOM generation, vulnerability scan output and build hashes.
