...
- [RUN-20260811-192 — RC13.3 acceptance and RC13.4 Governance knowledge](runs/RUN-20260811-192.md) — PR #153 exact-head accepted and merged as `2e1029a43f7b44d8525fb89197d0a10458a3e992`; RC13.4 implementation `PENDING_CI`.
- [RUN-20260811-191 — RC13.2 acceptance and RC13.3 governed Administration/RBAC](runs/RUN-20260811-191.md) — PR #152 exact-head accepted and merged as `b8c254c5d099cde5dca624aa85b17c320594847e`; point-in-time RC13.3 implementation record superseded by RUN-192 for current status.
...
- [RUN-20260811-176 — RC13.1 merge and RC13.2 single-session analytics](runs/RUN-20260811-176.md) — point-in-time RC13.1 acceptance / RC13.2 implementation record.
