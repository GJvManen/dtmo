...
CISCO_CREDENTIAL_ENV = "CISCO_OPENVULN_TOKEN"
CISCO_CREDENTIAL_REFERENCE = f"env:{CISCO_CREDENTIAL_ENV}"
...
SOURCE_CATALOG: tuple[CatalogSource, ...] = (
    ...
    CatalogSource(id="cisco-security-advisories", name="Cisco Security Advisories", endpoint_url="https://apix.cisco.com/security/advisories/v2", reliability="authoritative", category="vendor-advisories", execution_profile="cisco-openvuln-v2", execution_status="supported", provenance_note="Official Cisco PSIRT OpenVuln API v2. Runtime execution requires a bearer credential referenced outside source control.", recommended_interval_seconds=3600, secret_ref=CISCO_CREDENTIAL_REFERENCE),
    CatalogSource(id="redhat-security", name="Red Hat Product Security", endpoint_url="https://access.redhat.com/hydra/rest/securitydata", reliability="authoritative", category="vendor-advisories", execution_profile="redhat-csaf-v1", execution_status="supported", provenance_note="Official Red Hat Security Data API CSAF index and OASIS CSAF advisory documents.", recommended_interval_seconds=3600),
    CatalogSource(id="ubuntu-security-notices", name="Ubuntu Security Notices", endpoint_url="https://ubuntu.com/security/notices/rss.xml", reliability="authoritative", category="vendor-advisories", execution_profile="rss-2.0", execution_status="supported", provenance_note="Official Canonical Ubuntu Security Notices RSS feed, normalized through the governed RSS 2.0 adapter.", recommended_interval_seconds=3600),
    CatalogSource(id="debian-security", name="Debian Security Advisories", endpoint_url="https://www.debian.org/security/dsa", reliability="authoritative", category="vendor-advisories", execution_profile="rss-2.0", execution_status="supported", provenance_note="Official Debian Recent Security Advisories RSS feed (DSA), normalized through the governed RSS 2.0 adapter.", recommended_interval_seconds=3600),
    CatalogSource(id="apple-security-releases", name="Apple Security Releases", endpoint_url="https://support.apple.com/100100", reliability="authoritative", category="vendor-advisories", execution_profile="apple-security-releases-v1", execution_status="supported", provenance_note="Official Apple Security Releases index on Apple Support; bounded first-party discovery of Apple security-content documents.", recommended_interval_seconds=3600),
    CatalogSource(id="google-chrome-releases", name="Chrome Releases", endpoint_url="https://chromereleases.googleblog.com/", reliability="authoritative", category="vendor-advisories", execution_profile="chrome-security-releases-v1", execution_status="supported", provenance_note="Official Google Chrome Releases publication surface; bounded first-party stable-channel discovery with published CVE validation.", recommended_interval_seconds=3600),
    CatalogSource(id="mozilla-security-advisories", name="Mozilla Foundation Security Advisories", endpoint_url="https://www.mozilla.org/security/advisories/", reliability="authoritative", category="vendor-advisories", execution_profile="mozilla-mfsa-v1", execution_status="supported", provenance_note="Official Mozilla Foundation Security Advisories index and MFSA documents; bounded first-party discovery with published CVE validation.", recommended_interval_seconds=3600),
    CatalogSource(id="fortinet-psirt", name="Fortinet PSIRT Advisories", endpoint_url="https://www.fortiguard.com/psirt", reliability="authoritative", category="vendor-advisories", execution_profile="fortinet-psirt-v1", execution_status="supported", provenance_note="Official FortiGuard Labs PSIRT advisory index and first-party FG-IR detail documents; bounded discovery with published CVE validation.", recommended_interval_seconds=3600),
    CatalogSource(id="paloalto-security-advisories", name="Palo Alto Networks Security Advisories", endpoint_url="https://security.paloaltonetworks.com/rss.xml", reliability="authoritative", category="vendor-advisories", execution_profile="rss-2.0", execution_status="supported", provenance_note="Official Palo Alto Networks Security Advisories RSS feed, normalized through the governed RSS 2.0 adapter.", recommended_interval_seconds=3600),
    CatalogSource(id="broadcom-vmware-advisories", name="Broadcom VMware Security Advisories", endpoint_url="https://www.broadcom.com/support/vmware-security-advisories", reliability="authoritative", category="vendor-advisories", execution_profile="broadcom-vmware-vmsa-v1", execution_status="supported", provenance_note="Official Broadcom VMware Security Advisories landing page and first-party Broadcom Support VMSA detail documents; bounded discovery with published CVE validation.", recommended_interval_seconds=3600),
