...
SOURCE_CATALOG: tuple[CatalogSource, ...] = (
    ...
    CatalogSource(id="cert-eu-advisories", name="CERT-EU Security Advisories", endpoint_url="https://cert.europa.eu/publications/security-advisories/2026", reliability="authoritative", category="eu-security-advisories", execution_profile="cert-eu-advisories", execution_status="planned-parser", provenance_note="CERT-EU public security advisories with actionable technical recommendations and per-advisory JSON downloads.", recommended_interval_seconds=3600),
    CatalogSource(id="msrc-security-update-guide", name="Microsoft Security Response Center Security Update Guide", endpoint_url="https://msrc.microsoft.com/update-guide/", reliability="authoritative", category="vendor-advisories", execution_profile="vendor-msrc", execution_status="planned-parser", provenance_note="Official Microsoft Security Response Center vulnerability and security-update guidance.", recommended_interval_seconds=3600),
    CatalogSource(id="cisco-security-advisories", name="Cisco Security Advisories", endpoint_url="https://sec.cloudapps.cisco.com/security/center/publicationListing.x", reliability="authoritative", category="vendor-advisories", execution_profile="vendor-cisco", execution_status="planned-parser", provenance_note="Official Cisco product security advisory publication surface."),
