...
export function ThreatIntelligencePopulation({
  ...
  return (
    <section className="detail-section" aria-labelledby="population-title">
      ...
      <p>Only server-authorized source paths can be executed here. Registered sources must already be enabled. Supported built-in sources are exposed only when the Source Center reports a governed manual run as available. Activation, endpoint changes and credentials stay in Sources &amp; Collection.</p>
