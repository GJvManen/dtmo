      ...
      <div className="intelligence-workspace-grid">
        ...
        <article className="surface intelligence-detail-panel">
          ...
          {detail && <div className="intelligence-detail">
            ...
            <section className="detail-section object-actions" aria-label="Object actions"><h4>Continue investigation</h4><div className="quick-grid"><a className="quick-action" href={`/workbench/analysis?item=${encodeURIComponent(detail.id)}`}><span aria-hidden="true">⌁</span><div><strong>Analyze &amp; enrich</strong><small>Open persisted IntelOwl/Cortex history for this canonical object.</small></div></a></div><p className="boundary-copy">This pivot carries only the canonical object identifier. Analysis reloads server-authorized history and never executes an analyzer automatically; execution still requires <code>review:intelligence</code>.</p></section>
