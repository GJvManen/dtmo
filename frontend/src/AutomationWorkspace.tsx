    ...
    <section className="workspace-foundation" aria-labelledby="workspace-title">
      ...
      <div className="command-grid">
        ...
        <article className="surface command-panel">
          ...
          {selectedConnector && <button type="button" disabled={!executable || !selectedConnector.enabled || !selectedConnector.manual_run_available || execution.isPending} onClick={() => execution.mutate({ id: selectedConnector.id, registeredSource: selectedConnector.registered_source })}>Run bounded collection playbook</button>}
